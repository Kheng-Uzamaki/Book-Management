      ...
      <div className="containers" style={{ display: "flex" }}>
        ...
        <div className="right-column" style={{ width: "50%" }}>
          <div className="product-description">
            ...
            <i style={{ marginBottom: "3rem" }}>{"Author: "+product.author}</i>
            <p style={{fontWeight:'bold',fontSize:'1rem',margin:'10px 0px 0px'}}>BOOK DESCRIPTION :</p>
          ...
          <div className="product-price">
            ...
            >
              {product.productAvailable ? "Read" : "Out of Stock"}
            </button>
